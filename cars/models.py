...
class Car(UserRelatedModel):
    ...
    type = models.CharField(max_length=5, choices=TypeChoices.choices, blank=False)
    year = models.IntegerField(choices=YEAR_CHOICES, null=False)
    _class = models.CharField(
        verbose_name="class", max_length=5, choices=ClassChoices.choices, blank=False
    )
    color = models.CharField(max_length=5, choices=ColorChoices.choices, blank=False)
